...
Asset 1.1.0 is 6,471,924 bytes (about 6.17 MiB), with 51,808 triangles, 19 render meshes and five materials. Detailed measurements are recorded in the checked-in asset and geometry reports. Blender source and GLB reimport checks cover all forty physical numeral positions, manifold numeral solids and five lid poses. Browser checks exercise every detent, the wrap from 9 to 0, the 1942 combination, photographs and saved poses. The companion office kit is documented in OFFICE-QUALITY.md. Physical Quest frame time, stereo inspection and hand reach still require headset validation.
